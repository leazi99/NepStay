    ...
    <div className='min-h-screen bg-white text-gray-900 dark:bg-slate-950 dark:text-white'>
      ...
      <Routes>
        <Route element={<GlobalLayout />}>
          ...
          <Route path='/verifyemail' element={<VerifyEmail />} />
          <Route path='/find-jobs' element={<Navigate to='/guest-dashboard' replace />} />
          <Route path='/hotels' element={<HotelsList />} />
          <Route path='/hotels/:hotelId' element={<HotelDetail />} />
        </Route>
        <Route path='/guest-dashboard' element={<GuestDashboard />} />
        <Route path='/freelancer-dashboard' element={<Navigate to='/guest-dashboard' replace />} />
        <Route path='/job/:jobId' element={<RoomDetails />} />
        ...
        <Route element={<ProtectedRoutes requiredRole="customer" />}>
          <Route element={<DashboardLayout />}>
            ...
            <Route path='/my-proposals' element={<BookingsHistory />} />
        ...
        <Route element={<ProtectedRoutes requiredRole="hotelstaff" />}>
          <Route element={<DashboardLayout />}>
            ...
            <Route path='/employer-dashboard' element={<HotelStaffDashboard />} />
            ...
            <Route path='/post-job/:jobId/edit' element={<Navigate to='/manage-rooms/new' replace />} />
            <Route path='/manage-jobs' element={<ManageRooms />} />
            <Route path='/room/:roomId/manage' element={<ManageRooms />} />
            <Route path='/employer-job/:jobId' element={<ManageRooms />} />
            <Route path='/payments' element={<Payments />} />
            <Route path='/booking-requests/:jobId' element={<ReservationView />} />
            <Route path='/applicants/:jobId' element={<ReservationView />} />
            <Route path='/guest/:freelancerId' element={<GuestProfileView />} />
            <Route path='/freelancer/:freelancerId' element={<GuestProfileView />} />
            <Route path='/hotel-profile' element={<HotelProfile />} />
            <Route path='/company-profile' element={<HotelProfile />} />
          </Route>
        </Route>
