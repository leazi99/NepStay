    ...
    const fetchProfile = async () => {
      try {
        ...
        if (!response.data.success || !response.data.user) {
          setError(response.data.message || "Failed to load guest profile");
          return;
        }
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">
              View guest details before confirming
            </p>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            <div className="flex items-start gap-5">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-gray-500 mt-1">{profile?.role || "guest"}</p>
                ...
                <div className="mt-3">
                  ...
                  >
                    ...
                    {startingChat ? "Opening chat..." : "Message Guest"}
                  </button>
                </div>
                    ...
                    {completedProjects.map((project) => (
                      ...
                      >
                        <p className="text-sm font-semibold text-gray-900 inline-flex items-center gap-1.5">
                          ...
                          {project.job?.title || "Untitled Stay"}
                        </p>
                        <div className="mt-2 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-gray-600">
                          ...
                          <span>Hotel: {project.employer?.name || "Hotel"}</span>
                        </div>
                      </div>
                    ))}
                  </div>
                ) : (
                  <p className="text-sm text-gray-700">No completed stays yet</p>
                )}
              </div>
            </div>
          </div>
