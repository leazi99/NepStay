...
const styles = {
  ...
  formTitle: { fontSize: 24, fontWeight: 800, color: '#0f172a', margin: '0 0 8px', letterSpacing: '-0.4px', textAlign: 'center' },
  formSub: { color: '#64748b', fontSize: 13.5, margin: 0, lineHeight: 1.6, textAlign: 'center' },
  ...
  input: {
    width: '100%', padding: '13px 14px 13px 42px', fontSize: 14, borderRadius: 12,
    border: '1.5px solid', outline: 'none', transition: 'border-color 0.18s, box-shadow 0.18s',
    fontFamily: "'Inter', sans-serif", color: '#0f172a', background: '#f8fafc', boxSizing: 'border-box',
  },
  ...
  submitBtn: {
    ...
    letterSpacing: '0.1px', boxShadow: '0 6px 20px rgba(124,58,237,0.35)',
    transition: 'box-shadow 0.2s', cursor: 'pointer',
  },
  resendBtn: {
    display: 'inline-flex', alignItems: 'center', gap: 5, background: 'none',
    border: 'none', color: PURPLE, fontSize: 13, fontWeight: 600, cursor: 'pointer',
