...
const styles = {
  ...
  formTitle: { fontSize: 24, fontWeight: 800, color: '#0f172a', margin: '0 0 6px', letterSpacing: '-0.4px' },
  formSub: { color: '#64748b', fontSize: 13.5, margin: 0, lineHeight: 1.5 },
  ...
  toggleBtn: { position: 'absolute', right: 12, background: 'none', border: 'none', cursor: 'pointer', color: '#9ca3af', display: 'flex', alignItems: 'center', padding: 4 },
  errorMsg: { display: 'flex', alignItems: 'center', gap: 5, color: '#ef4444', fontSize: 12, fontWeight: 500, margin: 0 },
  errorBanner: {
    display: 'flex', alignItems: 'center', gap: 8, padding: '10px 14px', borderRadius: 10,
    background: '#fff1f2', border: '1px solid #fecdd3', color: '#be123c', fontSize: 13, fontWeight: 500, overflow: 'hidden',
  },
  submitBtn: {
    ...
    letterSpacing: '0.1px', boxShadow: '0 6px 20px rgba(124,58,237,0.35)', transition: 'box-shadow 0.2s', cursor: 'pointer',
  },
  backBtn: {
  ...
  signupPrompt: { textAlign: 'center', fontSize: 13, color: '#6b7280', marginTop: 24, fontWeight: 500 },
  signupLink: { color: PURPLE, fontWeight: 700, textDecoration: 'none' },
  successCard: {
    background: '#fff', borderRadius: 20, padding: '56px 44px', maxWidth: 420, width: '100%',
    textAlign: 'center', boxShadow: '0 24px 60px rgba(0,0,0,0.12)', position: 'relative', zIndex: 1,
  },
  successIcon: {
  ...
  successSub: { color: '#64748b', fontSize: 14, margin: '0 0 28px', lineHeight: 1.6 },
};
